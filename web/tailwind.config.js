  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'premium-lg': '0 10px 15px -3px rgba(0, 0, 0, 0.08), 0 20px 25px -5px rgba(0, 0, 0, 0.04), 0 40px 50px -10px rgba(0, 0, 0, 0.06)',
        'premium-xl': '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 40px 60px -12px rgba(0, 0, 0, 0.08)',
